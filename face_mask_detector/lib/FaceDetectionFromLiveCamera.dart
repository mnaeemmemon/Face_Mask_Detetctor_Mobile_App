...
class _FaceDetectionFromLiveCameraState
  ...
  void loadModel() async {
    await Tflite.loadModel(model: "assets/ml_trained_model/model_unquant.tflite",labels: "assets/ml_trained_model/labels.txt",);
  }
      ...
      child: cameraController == null
          ...
          : Stack(
              children: [
                ...
                ShowOutput(
                    _predictions == null ? [] : _predictions,
